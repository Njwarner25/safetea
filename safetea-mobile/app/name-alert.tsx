...
import { useNameAlertStore } from '../store/nameAlertStore';

export default function NameAlertScreen() {
  const user = useAuthStore((s) => s.user);
  const { watchedNames, matches, addEntry, removeEntry } = useNameAlertStore();
    ...
    return (
      <View style={styles.container}>
        <View style={styles.gateCard}>
          ...
          <Text style={styles.gateTitle}>Name Alert is a SafeTea+ Feature</Text>
        ...
        ListHeaderComponent={
          <View>
            ...
            <View style={styles.explainerCard}>
              <Text style={styles.explainerTitle}>How Name Alert Works</Text>
            ...
            <View style={styles.scenarioCard}>
              <View style={styles.scenarioBefore}>
                <Text style={styles.scenarioLabel}>{'❌  Without Name Alert'}</Text>
              ...
              <View style={styles.scenarioAfter}>
                <Text style={styles.scenarioLabel}>{'✅  With Name Alert'}</Text>
                <Text style={styles.scenarioTitle}>Informed decisions, every time</Text>
                <Text style={styles.scenarioText}>
                  You meet someone on a dating app. You add his name to Name Alert. Within
