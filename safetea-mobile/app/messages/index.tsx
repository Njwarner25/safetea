        ...
        ListEmptyComponent={
          loading ? (
            ...
            <View style={styles.empty}>
              <FontAwesome5 name="envelope-open" size={36} color={Colors.textMuted} />
...
const styles = StyleSheet.create({
  ...
  unreadBadge: { backgroundColor: Colors.coral, width: 22, height: 22, borderRadius: 11, justifyContent: 'center', alignItems: 'center' },
